...
Node* AVLTree::insertRecursive(Node*currentRoot, Node* newNode){
...
Node* AVLTree::searchRecursive(Node* currentRoot, int val){
...
Node* AVLTree::mostLeftChild(Node * currentRoot){
...
Node* AVLTree::successor(Node* currentRoot){
...
Node* AVLTree::removeRecursive(Node* currentRoot, int val){
    ...
    int bf = this->getBalance(currentRoot);
    if(bf > 1) {
        Node* nodoIntermedio = currentRoot->left;
...
void AVLTree::printHelper(string prefix, Node *currentRoot, bool isLeft)
{
    if( currentRoot != nullptr )
    {
        cout << prefix;
...
void AVLTree::inorderHelper(Node* currentRoot){
    if(currentRoot != nullptr){
...
void AVLTree::preorderHelper(Node* currentRoot){
    if(currentRoot != nullptr){
        cout << currentRoot->value << " ";
...
void AVLTree::postorderHelper(Node* currentRoot){
    if(currentRoot != nullptr){
